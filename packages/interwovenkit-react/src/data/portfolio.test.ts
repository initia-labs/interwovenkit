...
import { aggregatePortfolio, sortAssetGroups, sortChainsWithinGroup } from "./portfolio"
...
describe("sortAssetGroups", () => {
  ...
  it("should sort by total value (descending)", () => {
    ...
    expect(sorted.map(({ totalValue }) => totalValue)).toEqual([100, 50, 25])
  })
