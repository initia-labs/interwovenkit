...
export interface Config {
  ...
  /** Legacy generic auto-sign opt-in; explicit false also disables scoped policies. */
  ...
  /** Per-chain authorization scopes; a configured authorization opts its chain in. */
